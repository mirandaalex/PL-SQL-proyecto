...
BEGIN    
    ...
    vTotal1:= FT_TOTALMULTAS(vIDLECTOR); --ve el total de las multas
    IF vRESTANTES>0 THEN --AND vdisp= 'DISPONIBLE' AND vTotal = 0 THEN
    ...
    ELSIF vTotal <> 0 AND vrestantes>0  THEN--AND vdisp= 'DISPONIBLE' 
        RAISE_APPLICATION_ERROR (-20605,'TIENES MULTAS NO PUEDES SACAR MATERIAL');
    ELSE
